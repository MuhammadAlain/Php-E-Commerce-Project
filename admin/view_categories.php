    ...
    <div class="container mt-4">
        ...
        <div class="table-data">
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <tbody>
                    <?php
                    // Check if $con (database connection) is available
                    if (isset($con)) {
                        // Get Category info
                        ...
                        if (!$get_category_result) {
                            ...
                            while ($row_fetch_categories = mysqli_fetch_array($get_category_result)) {
                                ...
                                $category_title = htmlspecialchars($row_fetch_categories['category_title']); // Sanitize output
                        ...
                        echo "<tr><td colspan='4' class='text-danger'>Database connection not established.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
